...
function MyCars() {
  ...
  const buildUrl = () => {
    ...
    if (availability === "available" && minPrice && maxPrice) {
      ...
      return `${base}/by-owner?page=${page}&size=${size}`;
    }
  };
  ...
  <button
    ...
    onClick={() => navigate("/carowner/add-car")}
  >
    + Add Car
  </button>
</div>
                ...
                <div className="d-flex flex-column gap-2">
                  <div className="d-flex gap-2">
                    <button
                      ...
                      onClick={() => navigate(`/carowner/car-reviews/${c.id}`)}
                    >
                      Reviews
                    </button>
                    <button
                      className="btn btn-fanta flex-grow-1"
                      onClick={() => navigate(`/carowner/car-details/${c.id}`)}
                    >
                      Edit
                    </button>
                  </div>
