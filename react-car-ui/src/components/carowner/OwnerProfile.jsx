...
function OwnerProfile() {
  ...
  const handleDelete = async () => {
    if (window.confirm("Are you sure you want to delete your account? This action cannot be undone.")) {
      try {
        await axios.delete("http://localhost:8080/api/carowner/delete", {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
        });
  ...
  return (
    <div className="container mt-4">
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb fanta-breadcrumb">
              <li className="breadcrumb-item">
                <Link to="/carowner">CarOwner Dashboard</Link>
              </li>
      ...
      <h2 className="text-center fanta-heading mb-4">Car Owner Profile</h2>
          ...
          <div className="row align-items-start">
            <div className="col-md-8">
              ...
              <div className="mt-4 d-flex gap-3">
                <Link to="/carowner/edit-profile" className="btn btn-fanta px-4">
                  Edit Profile
                </Link>
