...
function Navbar() {
    ...
    return (
        <div>
           <nav className="navbar navbar-light bg-light justify-content-between px-4 shadow-sm">
  <div>
    <h2 className="platform-title m-0"><strong>RoadReady !!!</strong></h2>
    <p className="platform-tagline m-0" style={{ fontSize: "0.9rem", color: "#666" }}>
      "Travel Better, Drive Smarter"
    </p>
  </div>
                <div className="d-flex align-items-center">
                    <span className="me-4 fw-bold text-dark">
